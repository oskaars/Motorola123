  ...
  const cards = [
    {
      id: 1,
      title: "Rust Engine",
      desc: "The chess engine, powering the game's move validation. ",
    },
    {
      id: 2,
      title: "Mini-max Algorithm",
      desc: "Used to calculate the best possible moves for the chess engine by evaluating future game states.",
    },
    {
      id: 3,
      title: "Monte Carlo Tree Search",
      desc: "Sophisticated algorithm that simulates thousands of potential game outcomes to determine the most promising moves, adapting to any playing style.",
    },
    {
      id: 4,
      title: "Websocket",
      desc: "Secure, low-latency multiplayer connections allowing for seamless gameplay with opponents worldwide, with move synchronization in milliseconds.",
    },
    {
      id: 5,
      title: "Opening book Integration",
      desc: "Comprehensive database of chess openings and variations, allowing the engine to play strategic early-game positions based on centuries of chess theory.",
    },
    {
      id: 6,
      title: "Our own chess module",
      desc: "A custom chess module that handles all the game logic, including move validation, checkmate detection, and game state management.",
    },
  ];
      ...
      <div className="p-[1vw] min-h-[90vh] bg-gray-900 relative overflow-hidden">
        ...
        <div className="w-full px-[15vw] grid grid-cols-1 md:grid-cols-3 gap-[2vw] min-h-[70vh] relative z-10">
          {cards.map((card) => (
            <div
              key={card.id}
              className="card-container h-[50vh] lg:h-[40vh] transition-all duration-300 hover:scale-105 translate-z-0 will-change-transform"
            >
