  ...
  const handleSquareClick = (square: Square) => {
    ...
    if (selectedSquare) {
      ...
      if (moveResult) {
        ...
        if (activeTimer === null && game.turn === "b") {
            ...
            <div className="absolute top-0 left-0 w-full h-full flex flex-col">
              <div className="flex flex-1">
                ...
                <div className="flex-1 relative">
                  {isCheckmate && (
                    <div className="absolute inset-0 bg-red-500 bg-opacity-75 rounded-[1vh] flex flex-col items-center justify-center text-white text-4xl font-bold z-50">
                      <div>{timeOutWinner ? "TIME'S UP!" : "CHECKMATE!"}</div>
