      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-[4vh] lg:gap-[2vw] w-full justify-center items-center">
        {step === "menu" ? (
          <div className="flex flex-col lg:flex-row gap-[4vh] lg:gap-[2vw] w-full justify-center items-center">
            <div
              className="p-[2.5vh] rounded-[2vh] border-[0.4vh] border-purple-500/40 bg-gray-900/50 backdrop-blur-sm cursor-pointer transition-all hover:border-pink-500 w-[80vw] lg:w-[45vh] h-[35vh] flex flex-col justify-center items-center"
            ...
            >
              <FaSignInAlt className="text-[6vh] text-pink-400 mb-[2vh]" />
              <h3 className="text-[3.5vh] font-bold bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">
                Join Room
              </h3>
              <p className="text-gray-300 mt-[1vh] text-[2.2vh]">
          ...
          <div className="w-full max-w-[60vh] flex flex-col gap-[4vh] items-center">
            <input
              ...
              className="w-full px-[3vw] py-[2vh] text-[2.5vh] bg-gray-900/80 rounded-[2vh] border-[0.4vh] border-purple-500/40 text-white placeholder-gray-400 focus:outline-none focus:border-pink-500"
            />
